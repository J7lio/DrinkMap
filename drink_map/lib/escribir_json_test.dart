...
class FileManager {
  ...
  Future<void> saveData(Map<String, dynamic> data) async {
    try {
      ...
      final jsonString = jsonEncode(data); // Convertir Map a JSON
      await file.writeAsString(jsonString); // Escribir JSON en el archivo
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      // Guardar datos
      fileManager.saveData(exampleData);

      // Leer datos
      final loadedData = fileManager.loadData();
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              'Has pulsado PEPE have pushed the button this many times:',
            ),
            Text(
              '$_counter',
